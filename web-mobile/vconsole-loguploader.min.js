 ...
 */
! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports["vConsole-loguploader"] = t() : e["vConsole-loguploader"] = t()
}(this, function () {
    return function (e) {
        function t(n) {
        ...
        var u = o(5),
            s = n(u),
            c = window.vConsole.$,
            f = (window.vConsole.tool, function (e) {
                function t() {
                    var e;
                    r(this, t);
                    for (var o = arguments.length, n = Array(o), a = 0; a < o; a++) n[a] = arguments[a];
                    var l = i(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));
                ...
                return a(t, e), l(t, [{
                    ...
                    key: "uploadLog",
                    value: function () {
                        var e = this.getLogList();
                        this.upload(e)
                    }
                }, {
                    key: "uploadLocalStorage",
                    value: function () {
                        var e = this.getLocalStorageList();
                        this.upload(e)
                    }
                }, {
                    key: "getLogList",
                    value: function () {
                        var e = c.one(".vc-logbox"),
                            t = c.all(".vc-item-content", e),
                            o = [],
                            n = !0,
                            r = !1,
                            i = void 0;
                    ...
                    value: function (e) {
                        var t = this,
                            ...
                            n = Zepto;
                        Zepto ? n = Zepto : jQuery && (n = jQuery), n.ajax({
                            type: "POST",
                            url: this.logPostURL,
                            data: JSON.stringify(o),
                            contentType: "application/json",
                            success: function (e) {
                                var o = c.one(".vc-log-id");
                                o.innerHTML = c.render("<div>Your log is uploaded</div><div>Log URL: <span ><a>{{logURL}}</a></span></div>", {
                                    logURL: t.logPostURL.replace("postLog", "") + "uploaded/" + e
                                }, !0)
                            },
                            error: function (e) {
                                var t = c.one(".vc-log-id");
        ...
        function i(e, t) {
            var o = h(),
                n = m[m.length - 1];
            if ("top" === e.insertAt) n ? n.nextSibling ? o.insertBefore(t, n.nextSibling) : o.appendChild(t) : o.insertBefore(t, o.firstChild), m.push(t);
            else {
        ...
        function s(e, t) {
            ...
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (o = u(t), n = p.bind(null, o), r = function () {
                a(o), o.href && URL.revokeObjectURL(o.href)
            }) : (o = l(t), n = f.bind(null, o), r = function () {
                a(o)
            });
            return n(e),
                function (t) {
